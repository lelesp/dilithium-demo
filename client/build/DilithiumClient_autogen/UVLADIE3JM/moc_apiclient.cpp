...
Q_CONSTINIT static const qt_meta_stringdata_ApiClient_t qt_meta_stringdata_ApiClient = {
    {
        ...
        QT_MOC_LITERAL(10, 10),  // "fileSigned"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 7),  // "zipData"
        QT_MOC_LITERAL(30, 13),  // "errorOccurred"
        QT_MOC_LITERAL(44, 5),  // "error"
        QT_MOC_LITERAL(50, 15)   // "onSignFileReply"
    },
    "ApiClient",
    "fileSigned",
    "",
...
void ApiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->fileSigned((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->errorOccurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onSignFileReply(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ApiClient::*)(const QByteArray & );
            if (_t _q_method = &ApiClient::fileSigned; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ApiClient::fileSigned(const QByteArray & _t1)
{
